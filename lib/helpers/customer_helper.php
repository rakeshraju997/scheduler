...
class OsCustomerHelper {
  ...
  public static function can_cancel_booking($booking){
    if(OsSettingsHelper::is_on('allow_customer_booking_cancellation')){
      if($booking->status != LATEPOINT_BOOKING_STATUS_CANCELLED) return true;
    }
    return false;
  }


  public static function create_customer_for_wp_user($wp_user){
