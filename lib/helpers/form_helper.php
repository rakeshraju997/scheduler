...
class OsFormHelper {
  ...
  public static function toggler_field($name, $label, $is_active, $controlledToggleId = false, $size = 'normal'){
    ...
    if($label) $html.= '<div class="os-form-group os-form-toggler-group">';
      ...
      $html.= '<div '.$controlledToggleHtml.' class="os-toggler '.$status.' size-'.$size.'" data-is-string-value="true" data-for="'.$name.'"><div class="toggler-rail"><div class="toggler-pill"></div></div></div>';
