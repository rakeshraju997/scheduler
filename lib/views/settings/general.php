  ...
  <form action="" data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'update'); ?>">
    ...
    <div class="white-box">
      ...
      <div class="white-box-content">
        <div class="os-row">
          <div class="os-col-lg-6">
            <?php echo OsFormHelper::checkbox_field('settings[wp_users_as_customers]', __('Use WordPress users as customers', 'latepoint'), 'on', OsSettingsHelper::is_on('wp_users_as_customers')); ?>
          </div>
          <div class="os-col-lg-6">
            <?php echo OsFormHelper::checkbox_field('settings[allow_customer_booking_cancellation]', __('Allow customers cancel their bookings', 'latepoint'), 'on', OsSettingsHelper::is_on('allow_customer_booking_cancellation')); ?>
          </div>
        </div>
      </div>
    </div>
